...
//THIS FUNCTION PREVENTS FORM SUBMISSION VALIDATES CITY AND FETCHES DATA VIA API
            ...
            <div className='bg-transparent backdrop-filter backdrop-blur-md rounded-xl shadow-2xl p-8 max-w-md text-white w-full border border-white/30 relative z-10'>
                ...
                {!weather ? (
                  ...
                  <div className='mt-6 text-center transition-opacity duration-500'>
                    <button onClick={() => { setWeather(null); setCity('')}} className='mb-4 bg-purple-900 hover:bg-blue-700 text-white font-semibold py-1 px-3 rounded transition-colors'>
                      New Search
                    </button>
                    ...
                    <div className='flex justify-between items-center'>
                      ...
                      <button onClick={()=> setUnit(u => u==='C' ? 'F' : "C")} className='bg-blue-700 hover:bg-blue-800 text-white font-semibold py-1 pz-3 rounded transition-colors'>&deg;{unit}</button>
                    </div>
